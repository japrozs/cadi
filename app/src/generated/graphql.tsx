...
export type MsgResponse = {
  __typename?: 'MsgResponse';
  sent?: Maybe<Array<Message>>;
  received?: Maybe<Array<Message>>;
};
...
export type GetAllMessagesQuery = (
  { __typename?: 'Query' }
  & { getAllMessages?: Maybe<Array<(
    { __typename?: 'Message' }
    & Pick<Message, 'from' | 'to' | 'msg' | 'createdAt'>
  )>> }
);
...
export type GetMessageQuery = (
  ...
  & { getMessages: (
    ...
    & { sent?: Maybe<Array<(
      { __typename?: 'Message' }
      & Pick<Message, 'id' | 'msg' | 'createdAt'>
    )>>, received?: Maybe<Array<(
      { __typename?: 'Message' }
      & Pick<Message, 'id' | 'msg' | 'createdAt'>
    )>> }
  ) }
...
export type GetUsersQuery = (
  ...
  & { getUsers?: Maybe<Array<(
    { __typename?: 'User' }
    & Pick<User, 'id' | 'imgUrl' | 'description' | 'username'>
  )>> }
);
...
export const CreateMessageDocument = gql`
    mutation createMessage($from: String!, $to: String!, $msg: String!) {
  createMessage(from: $from, to: $to, msg: $msg)
}
    `;
...
export const GetAllMessagesDocument = gql`
    query getAllMessages($from: String!) {
